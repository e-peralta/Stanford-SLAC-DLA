...
plot(t0,v0,'Color',col1,'LineWidth',1)
ax=gca;
...
export_fig TemporalOverlap.eps -rgb -r300 %-painters
...
% hold on
line([t2(p2+1) t2(p2+1)],[2 17],'LineWidth',2,'Color',col2,'LineStyle',':');
hold on

h1=plot(t1,v1,'Color',col1,'LineWidth',1)
hold on
h2=plot(t2,v2,'Color',col3,'LineWidth',2)

hold on
h3=plot(t1(2:end),diff(v1),'--','Color',col2,'LineWidth',2)
hold on
h4=plot(t2(2:end),diff(v2),'--','Color',col4,'LineWidth',1)
axis tight
xlim([200 2500])
ax=gca;
hx=xlabel('Arrival time,{\it t} [ps]');
...
export_fig TemporalOverlap2.eps -rgb -r300 %-painters
